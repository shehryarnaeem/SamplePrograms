...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "loginapp\0on_pushButton_clicked\0"
};
...
void loginapp::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        loginapp *_t = static_cast<loginapp *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject loginapp::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_loginapp.data,
      qt_meta_data_loginapp,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *loginapp::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_loginapp.stringdata0))
        return static_cast<void*>(const_cast< loginapp*>(this));
